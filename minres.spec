...
Implementacja gradientowej metody rozwiązywania rzadkich układów
równań liniowych, postaci Ax = b albo (A - sI)x = b. Macierz A - sI
musi być symetryczna, ale może być określona, nieokreślona lub
osobliwa. Skalar s może być dowolną liczbą. Metoda jest oparta na
trójdiagonalizacji Lanczosa. Można jej dostarczyć dodatnio określony
preconditioner. W rzeczywistości, MINRES rozwiązuje problem metody
